...
console.log(typeof gsap); // Should print "function"
console.log(typeof ScrollTrigger); // Should print "object"
...
canvas();
gsap.to("#page25>video",{
    ScrollTrigger:{
        trigger:`#page25>video`,
        start :`2% top`,
        end: `bottom top`,
        scroller: `#main`
    },
    onStart:()=>{
        document.querySelector("#page25>video").play()
    }
})
gsap.to("#page25",{
    ScrollTrigger:{
